...
public class EmailRandomizer {
	...
	public static Stream<String> sweepstake(String seedString, Collection<String> emails, int winnerCount) {
		return new EmailCollection(new Random(stringToSeed(seedString)), emails).randomEmails(winnerCount);
	}
	
	public static String getWinnersCommaSeparated(String seedString, Collection<String> emails, int winnerCount) {
